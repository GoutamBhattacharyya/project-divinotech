...
// $(function () { //pagepiling second section delay // contains animation slide effect  .delay( 1200 )
//     checkMyPage();
//     //$('#ballot').bind('wheel', function (e) {
    
//         $('#ballot').bind('mousewheel', function(e){
...
//mouseover animate
$(function () {
    $("#rp, #view, .logo img, #nav-icon2, #lp, #bx1, .accord .ptm i, .accord .ptm, .owl-prev, .owl-next, a, button, #psh, a#rp, #mod_btn p, #mod_btn p i, #psh1, .styled-checkbox + label, .push_right, .box label, #mod_btn").mouseover(function () {
        $(this).css({
            "opacity": 0.2,
